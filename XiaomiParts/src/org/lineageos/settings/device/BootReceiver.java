...
public class BootReceiver extends BroadcastReceiver implements Utils {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Settings.Secure.getInt(context.getContentResolver(), PREF_ENABLED, 0) == 1) {
            ...
            String rgbValue = String.valueOf(Settings.Secure.getInt(context.getContentResolver(),
                    PREF_RED, RED_DEFAULT)) + " " +
                    String.valueOf(Settings.Secure.getInt(context.getContentResolver(), PREF_GREEN,
                            GREEN_DEFAULT)) + " " +
                    String.valueOf(Settings.Secure.getInt(context.getContentResolver(), PREF_BLUE,
                            BLUE_DEFAULT));
