...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private static final int SCANCODE_PLATINA_UP = 103;
    private static final int SCANCODE_PLATINA_DOWN = 108;
    private static final int SCANCODE_PLATINA_LEFT = 105;
    private static final int SCANCODE_PLATINA_RIGHT = 106;
